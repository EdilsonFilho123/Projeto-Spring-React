...
O projeto Spring-React é uma aplicação full-stack construida através dos conhecimentos obtidos no evento **Semana Spring React** (Organizado pela [DevSuperior](https://devsuperior.com.br "Site da DevSuperior")) junto com as experiências dos autores.
...
- [Linkedin](https://www.linkedin.com/in/edilson-claudio-silvestrini-filho-5090b2208/)
- [Celular / Whatsapp](https://api.whatsapp.com/send?phone=5519983724834)

## Gabriel Vendrame Rosin
- [Email](gubirosin@gmail.com)
- [Celular / Whatsapp](https://api.whatsapp.com/send?phone=5519982148795)
